...
public class VerticalProgressBar extends View {
    ...
    public VerticalProgressBar(Context context, AttributeSet attrs, int defStyle) {
        ...
        mPaddingLeft = a.getDimensionPixelSize(R.styleable.ProgressBar_android_paddingLeft, mPaddingLeft);
        mPaddingRight = a.getDimensionPixelSize(R.styleable.ProgressBar_android_paddingRight, mPaddingRight);
        ...
        setSecondaryProgress(a.getInt(R.styleable.ProgressBar_android_secondaryProgress,
                mSecondaryProgress));
    ...
    private Drawable tileify(Drawable drawable, boolean clip) {
        ...
        if (drawable instanceof LayerDrawable) {
            ...
            return (clip) ? new ClipDrawable(shapeDrawable, Gravity.BOTTOM, ClipDrawable.VERTICAL)
                    : shapeDrawable;
        }
