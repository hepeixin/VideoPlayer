package ucweb.video.player.view.adapter;
...
import ucweb.web.ui.adapter.UCBaseAdapter;

/**
 * desc: video.web.activity list video.view.video.player.view.adapter
 * <br/>
 ...
 * version: 1.0
 */
public class SeriesListAdapter extends UCBaseAdapter<VideoEntity> {

    private Context c;

    private LayoutInflater inflater;

    public SeriesListAdapter(Context c, List<VideoEntity> videoList) {
        super(videoList);
        this.c = c;
...
//        LogUtil.i("VideoListAdapter", "getView position = " + position);
        ...
        if (convertView == null) {
            ...
            convertView = inflater.inflate(R.layout.series_list_item, null);
